  ...
  return (
    ...
    >
      <div className="flex h-full min-h-[1000px]  w-[800px] flex-col items-start justify-start rounded-xl  ">
        ...
        <div className="size-full rounded-b-xl bg-white   px-10 pb-10 ">
          <div className="body-4 flex size-full flex-col items-start justify-start gap-6 border-x-2 border-b-2 border-gray-400 p-6 ">
