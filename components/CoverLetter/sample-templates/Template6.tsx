  ...
  return (
    ...
    >
      <div className="flex h-full min-h-[1000px]  w-[800px] flex-col items-start justify-start rounded-xl shadow-xl shadow-gray-400 ">
        <div className="h-48 w-full rounded-t-xl bg-gray-700 px-10 ">
          <div className="flex  size-full items-center justify-center ">
            <div className="flex h-auto w-full items-center justify-start gap-10 ">
              <div className="flex-center gap-8">
                <div className=" flex-center rounded-full border-2 border-gray-500 bg-gray-800 p-4 text-white">
                  <p className="h3">
                    {String("John Doe")
                      .split(" ")
                      .map((name) => name[0])
              ...
              <div className="flex-start body-3 flex-col gap-1 font-bold text-white">
                <p className="h3 uppercase">John Doe</p>
